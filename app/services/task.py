...
def generate_audio(task_id, params, video_script):
    ...
    # so read it defensively here to avoid an AttributeError when those endpoints are called directly.
...
def start(task_id, params: VideoParams, stop_at: str = "video"):
    ...
    # Only the full video-generation flow needs to handle the video concat mode;
    # this avoids /subtitle and /audio style requests touching fields that don't exist on them.
